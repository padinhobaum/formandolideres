      ...
      <div className="max-w-4xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <button onClick={() => navigate("/mural")} className="border bg-card p-4 text-left hover:bg-secondary transition-colors">
            ...
            <p className="font-heading font-bold text-3xl text-primary">{notices.length}</p>
          </button>
          <button onClick={() => navigate("/materiais")} className="border bg-card p-4 text-left hover:bg-secondary transition-colors">
            ...
            <p className="font-heading font-bold text-3xl text-primary">{materials.length}</p>
          </button>
          <button onClick={() => navigate("/alunos")} className="border bg-card p-4 text-left hover:bg-secondary transition-colors">
            ...
            <p className="font-heading font-bold text-3xl text-primary">{studentCount}</p>
          </button>
        </div>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 px-0 py-0">
              {videoLessons.map((v) => {
              ...
              className="w-full border bg-card p-4 text-left hover:bg-secondary transition-colors">
                ...
                <img src={n.image_url} alt="" className="w-10 h-10 object-cover rounded flex-shrink-0" loading="lazy" />
                    ...
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      ...
                      <span className="font-heading font-medium truncate text-base">{n.title}</span>
                    </div>
