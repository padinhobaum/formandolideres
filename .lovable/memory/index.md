...
- **Sidebar Order**: Home, Mural, Fórum, LíderAI, Videoaulas, Materiais, Ao Vivo, Resultados, Propostas.
...
- [LíderAI Mobile Layout](mem://ui-ux/lider-ai-mobile-layout) — Mobile layout constraints for sticky header and suggestions
...
- [Forum UI Design](mem://features/forum/ui-redesign) — Twitter-inspired design, custom admin category colors
...
- [Login Screen Design](mem://features/auth/login-screen-design) — Split-screen desktop login with password visibility toggle
...
- [Certificates Management](mem://features/certificates/management-and-verification) — PDF certificate generation with QR code verification
- [Notices Functionality and Interaction](mem://features/notices/functionality-and-interaction) — WhatsApp sharing and forwarding acknowledgment
...
- [Edital de Propostas](mem://features/edital-propostas) — Sistema de propostas colaborativas com fases, votação, ranking e feedback da Direção
